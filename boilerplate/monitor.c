 ...
 * runs in softirq context where sleeping is forbidden. Mutexes can
 * sleep; spinlocks cannot, making spinlocks the only safe choice
 * for code paths that include both timer callbacks and ioctl handlers.
 * ============================================================== */
